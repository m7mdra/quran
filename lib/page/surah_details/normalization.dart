extension Normalization on String {
  /// replaceAll arabic diacritics from caller
  /// example:
  /// var input = "بِسْمِ ٱللَّهِ ٱلرَّحْمَٰنِ ٱلرَّحِيم";
  /// print(input.normalize());
  /// print(input.contains("بسم الله")); will return true
  String normalize() {
    return this
